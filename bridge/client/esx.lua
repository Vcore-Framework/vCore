...
RegisterNetEvent('vCore:Client:OnPlayerLoaded', function()
    ...
    ESX.PlayerData = {
        ...
        accounts = {
            {name = 'money', money = currencies.cash or 0, label = 'Cash'},
            {name = 'bank', money = currencies.bank or 0, label = 'Bank'},
            {name = 'black_money', money = currencies.crypto or 0, label = 'Black Money'},
        },
